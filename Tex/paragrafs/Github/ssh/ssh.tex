...
Открыв VirtualBox и войдя в свою виртуальную машину, открыли терминал и перешли в папку с «Час ЕГЭ» с помошью команды \texttt{cd git/chas-ege}.
...
\\ \quad Приведение локальных файлов в соответсвие с актуальным состоянием репозитория:
\\ \texttt{git checkout origin/devel:}